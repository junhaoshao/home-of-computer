...
app.get("/getcomment",(req,res)=>{
  ...
  var progress = 0;
  var obj = {code:1};
  obj.user_uname = req.session.uname;
  //5:创建sql1 查询总记录数   严格区分大小写
...
app.get("/goodsList",(req,res)=>{
  var obj = [];
  obj.push({id:1,title:"小辣椒",old:999,now:899,img_url:"http://127.0.0.1:3000/img/banner1.png"});
  obj.push({id:2,title:"中辣椒",old:999,now:899,img_url:"http://127.0.0.1:3000/img/banner2.png"});
  obj.push({id:3,title:"大辣椒",old:999,now:899,img_url:"http://127.0.0.1:3000/img/banner3.png"});
  obj.push({id:4,title:"老辣椒",old:999,now:899,img_url:"http://127.0.0.1:3000/img/banner4.png"});
  res.send(obj);
})
...
app.post("/upload",upload,single("mypic"),(req,res)=>{
	...
	if(size>2){
		res.send({code:1,msg:"上传文件过大不能超过2M"});
		return;
	}
	//4判断类型
